...
<body >
    ...
    <!-- container -->
    <div class="container"> 
        <form method="post" action="../controller/insertVideos.php" class="form-signin">
            <div class="panel panel-info" >
                <div class="panel panel-heading" align="center">
                    <h2 class="form-signin-heading">Llene el formulario para registrar un video</h2>
                    <hr/>
                </div>
                <div class="panel-body">
                    ...
                    <label >Género</label>
                    <input type="text" id="genre" name="genre" class="form-control" placeholder="Género" required/>
                    <label  >Url del video(Solo la parte del final)</label>
                    ...
                    <br/>
                    <button class="btn btn-lg btn-primary btn-block" >Agregar Video</button>
                </div>
            </div>
        </form>
